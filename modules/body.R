      ...
      argonRow(
        argonColumn(
          ...
          htmltools::tags$div(
            ...
            htmltools::tags$div(
              ...
              pickerInput("allele", "Select allele",
                choices = NULL,
        ...
        argonColumn(
          ...
          argonTabSet(
            ...
            argonTab(
              tabName = "Worldmap", active = T,
              uiOutput("render_plots"),
              uiOutput("rrender_add_info")
            ),
            argonTab(
              tabName = "Data", active = F,
    ...
    argonTabItem(
      ...
      fluidRow(
        column(
          width = 12,
          argonTabSet(
            horizontal = T, id = "tabset_tool", size = "sm",
            width = 12,
            iconList = list(
              argonIcon("single-02"), argonIcon("world"),
              argonIcon("chart-bar-32"), argonIcon("square-pin"),
              argonIcon("ambulance")
            ),

            # High-risk genotype frequency -------------------------------------------------------------------
            argonTab(
              tabName = "High-risk genotype frequency", active = T,
              argonCard(
                status = "primary",
                width = 12,
                border_level = 1,
                ...
                argonRow(
                  argonColumn(
                    width = 4,
                    pickerInput("tools_act_method", "Select method",
                      width = "100%", choices = c("Dunnenberger (2015)", "CPIC function"),
                      selected = "CPIC function"
                    )
                  ),
                  argonColumn(
                    width = 4,
                    pickerInput("tools_act_mapping_method", "Choose",
                      width = "100%",
            ...
            argonTab(
              ...
              argonCard(
                ...
                argonRow(
                  argonColumn(
                    width = 4,
                    pickerInput("tools_freq_countries", "Select regions",
                      width = "100%", choices = data$freq_per_subgroup$subgroup %>% unique() %>% sort(),
                  ...
                  argonColumn(
                    width = 4,
                    pickerInput("tools_freq_gene", "Select a gene",
                      width = "100%", choices = data$genes, select = "CYP2D6",
                      multiple = F
                    )
                  ),
                  argonColumn(
                    width = 4,
                    pickerInput("tools_freq_allele", "Select at least one allele",
                      width = "100%", choices = "",
                      multiple = T, options = pickerOptions(actionsBox = T, liveSearch = T)
                    )
                  )
            ...
            # Intra-biogeographic variability -----------------------------------------
            argonTab(
              tabName = "Intra-biogeographic variability",
              argonCard(
                status = "primary",
                width = 12,
                border_level = 1,
                ...
                argonRow(
                  argonColumn(
                    width = 4,
                    pickerInput("tools_var_gene", "Select a gene",
                      width = "100%", choices = sort(unique(data$freq_per_country$gene)),
                      selected = "CYP2D6", multiple = F
                    )
                  ),
                  argonColumn(
                    width = 4,
                    pickerInput("tools_var_allele", "Select at least one allele",
                      width = "100%", choices = "",
                      multiple = T, options = pickerOptions(actionsBox = T, liveSearch = T)
                    )
                  )
                ...
                argonRow(
                  argonColumn(width = 12, center = T, div(jqui_resizable(plotlyOutput("tool_var_plot", height = "600px", width = "95%")), align = "center") %>%
            ...
            argonTab(
              ...
              argonCard(
                ...
                argonRow(
                  argonColumn(
                    width = 3,
                    pickerInput("tools_var_contgene_gene", "Select a gene",
                      width = "100%", choices = sort(unique(data$freq_per_country$gene)),
                  ...
                  argonColumn(
                    width = 4,
                    pickerInput("tools_var_contgene_gene_country", "Select a country",
                      width = "100%", choices = NA,
                      multiple = T, options = pickerOptions(actionsBox = T, liveSearch = T)
                    )
                  ),
            ...
            # Metabolizer status tool ------------------------------------------------------------
            argonTab(
              tabName = "Metabolizer status tool",
              argonCard(
                status = "primary",
                width = 12,
                border_level = 1,
           ...
           for pharmacogenes according to established guidelines. Countries are not listed in the selection when too many key alleles for the phenotypes are missing.  
                ...
                argonRow(
                  argonColumn(
                    width = 3,
                    pickerInput("tools_var_function_gene", "Select a gene",
                      width = "100%", choices = sort(unique(tool_function$gene)),
                      selected = "CYP2D6", multiple = F
                    )
                  ),
                  ...
                  argonColumn(
                    width = 4,
                    pickerInput("tools_var_function_country", "Select a country",
                      width = "100%", choices = NA,
                      multiple = T, options = pickerOptions(actionsBox = T, liveSearch = T)
                    )
                  )
